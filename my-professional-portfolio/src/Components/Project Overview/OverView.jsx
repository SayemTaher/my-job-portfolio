                    ...
                    <div className="flex mt-10  flex-col justify-center gap-20" data-aos="fade-up-left">
                        <Fade>
                            <div className="flex flex-col  gap-5 bg-gray-100 p-5 rounded-xl ">
                                <div className="flex justify-between  items-center ">
                                    <h1 className="text-xl font-bold">Front-End Development <sup className="font-normal bg-primaryBlue  text-white p-2 rounded-full">React Based</sup></h1>
                                    <FiAirplay className="text-6xl"></FiAirplay>

                                </div>
                                <div className="flex flex-col justify-center items-center">
                                    <div className="stat flex flex-col justify-center shadow-xl w-[250px]  items-center bg-white p-5 rounded-2xl">
                        ...
                        <Fade>
                            <div className="flex flex-col  gap-5 bg-gray-100 p-5 rounded-xl ">
                                <Fade>
                                    <div className="flex justify-between  items-center ">
                                        <h1 className="text-xl font-bold">Mobile Application Development <sup className="font-normal bg-primaryBlue  text-white p-2 rounded-full">iOS Based</sup></h1>
                                        <FaApple className="text-6xl"></FaApple>
                                ...
                                <div className="flex justify-center flex-col items-center">
                                    ...
                                    <Fade>
                                        <div className="stat shadow-xl flex flex-col justify-center w-[250px]  items-center bg-white p-5 rounded-2xl">
                                            <div className="stat-figure text-secondary">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className="inline-block w-8 h-8 stroke-current"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4"></path></svg>
                                            </div>
                                            <div className="stat-title">Projects Completed</div>
