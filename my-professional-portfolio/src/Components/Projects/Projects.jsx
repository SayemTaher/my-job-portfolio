      ...
      <section className="py-20 bg-gradient-to-br from-indigo-900 via-navy-900 to-slate-900 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-8 gap-6 max-w-6xl mx-auto">
            {[
              {
                icon: <ImHtmlFive className="text-5xl text-orange-500" />,
                name: "HTML5",
              },
              {
                icon: <SiCss3 className="text-5xl text-blue-600" />,
                name: "CSS3",
              },
              {
              ...
              {
                icon: <FaNodeJs className="text-5xl text-cyan-400" />,
                name: "Node.js",
              },
              {
              ...
              {
                icon: <SiMongodb className="text-5xl text-blue-300" />,
                name: "MongoDB",
              },
              {
